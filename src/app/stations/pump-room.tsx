...
function normalizeFloatInput(value: string) {
  ...
  return `${cleanedValue.slice(0, firstDecimalIndex + 1)}${cleanedValue
...
function FlowRateField({
  ...
  return (
    <View style={styles.fieldBlock}>
      ...
      <View style={styles.flowStepperRow}>
        <TouchableOpacity
          style={[
            styles.stepperButton,
            isMinimumFlowRate && styles.stepperButtonDisabled,
          ]}
          onPress={() => onStep(-FLOW_RATE_STEP_M3H)}
          disabled={isMinimumFlowRate}>
          <Feather
            name="minus"
            size={18}
            color={isMinimumFlowRate ? AppColors.textSubtle : AppColors.text}
          />
        </TouchableOpacity>

        <View style={styles.flowInputShell}>
          <TextInput
          ...
          />
          <Text style={styles.flowUnitText}>m3/h</Text>
        </View>

        <TouchableOpacity
          style={styles.stepperButton}
          onPress={() => onStep(FLOW_RATE_STEP_M3H)}>
          <Feather name="plus" size={18} color={AppColors.text} />
        </TouchableOpacity>
      </View>
    </View>
  );
    ...
    <View style={styles.dashboardFieldBlock}>
      <View style={styles.dashboardToggleRow}>
        ...
        <Switch
          ...
          trackColor={{ false: AppColors.border, true: AppColors.surfaceError }}
          thumbColor={value ? AppColors.error : AppColors.textSubtle}
        />
      </View>
    </View>
  );
...
// Dashboard status input maps PLC codes to operational status labels.
...
// Dashboard float inputs render numeric values with a fixed unit label.
function DashboardFloatField({
  label,
  value,
  unit,
  onChange,
  ...
  return (
    <View style={styles.dashboardFieldBlock}>
      ...
      <View style={styles.dashboardInputShell}>
        <TextInput
          value={value}
          onChangeText={(nextValue) => onChange(normalizeFloatInput(nextValue))}
          placeholder="0"
          placeholderTextColor="#9AA09A"
          style={styles.dashboardNumberInput}
          keyboardType="decimal-pad"
        />
        <Text style={styles.dashboardUnitText}>{unit}</Text>
      </View>
    </View>
  );
}
...
function DashboardFlowRateField({
  ...
  return (
    <View style={styles.dashboardFieldBlock}>
      <Text style={styles.fieldLabel}>Flow Discharge</Text>
